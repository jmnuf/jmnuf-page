...
export const LowBatterySVG:React.FC<{ size: string | number }> = ({ size }) => {
...
export const ScreenPlaySVG:React.FC<{ size: string | number }> = ({ size }) => {
    return <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={size} height={size}><path d="M21.5,0H2.5C1.122,0,0,1.122,0,2.5v15.5H24V2.5c0-1.378-1.122-2.5-2.5-2.5Zm1.5,17H1V2.5c0-.827,.673-1.5,1.5-1.5H21.5c.827,0,1.5,.673,1.5,1.5v14.5Zm-15-3.065l8.633-4.935L8,4.066V13.935Zm1-8.145l5.618,3.21-5.618,3.211V5.79Zm-1,14.21c-.929,0-1.705,.64-1.929,1.5H0v1H6.071c.224,.86,1,1.5,1.929,1.5s1.705-.64,1.929-1.5h14.071v-1H9.929c-.224-.86-1-1.5-1.929-1.5Zm0,3c-.551,0-1-.448-1-1s.449-1,1-1,1,.448,1,1-.449,1-1,1Z"/></svg>;
};
...
export const DocumentCircleWrongSVG:React.FC<{ size: string | number }> = ({ size }) => {
    return <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={size} height={size}><path d="m10.5,23h-6c-1.93,0-3.5-1.57-3.5-3.5V4.5c0-1.93,1.57-3.5,3.5-3.5h5.515c.334,0,.663.03.985.087v5.413c0,1.378,1.121,2.5,2.5,2.5h5.813c.154,0,.3-.071.395-.193s.128-.281.09-.431c-.289-1.13-.878-2.163-1.702-2.987l-3.484-3.485c-1.229-1.228-2.861-1.904-4.597-1.904h-5.515C2.019,0,0,2.019,0,4.5v15c0,2.481,2.019,4.5,4.5,4.5h6c.276,0,.5-.224.5-.5s-.224-.5-.5-.5ZM12,1.368c.705.273,1.353.692,1.904,1.243l3.484,3.485c.543.542.965,1.192,1.24,1.904h-5.129c-.827,0-1.5-.673-1.5-1.5V1.368Zm5.5,9.632c-3.584,0-6.5,2.916-6.5,6.5s2.916,6.5,6.5,6.5,6.5-2.916,6.5-6.5-2.916-6.5-6.5-6.5Zm0,12c-3.032,0-5.5-2.468-5.5-5.5s2.468-5.5,5.5-5.5,5.5,2.468,5.5,5.5-2.468,5.5-5.5,5.5Zm2.854-7.646l-2.146,2.146,2.146,2.146c.195.195.195.512,0,.707-.098.098-.226.146-.354.146s-.256-.049-.354-.146l-2.146-2.146-2.146,2.146c-.098.098-.226.146-.354.146s-.256-.049-.354-.146c-.195-.195-.195-.512,0-.707l2.146-2.146-2.146-2.146c-.195-.195-.195-.512,0-.707s.512-.195.707,0l2.146,2.146,2.146-2.146c.195-.195.512-.195.707,0s.195.512,0,.707Z"/></svg>
};
