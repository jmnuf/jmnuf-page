...
export default async function Home() {
  ...
  return (
    <div className="flex h-full w-full animate-fadeIn flex-col opacity-0">
      ...
      <div className={"flex h-5/6 w-full px-8"}>
...
const GameSlot: React.FC<{
  ...
  return (
    <div className="group flex h-3/4 flex-col justify-center">
      <h2
        id={headerId ?? title}
        className="text-bold select-none text-center text-sky-600 opacity-50 group-hover:select-auto group-hover:opacity-100"
      >
        {title}
      </h2>
      {href ? (
